	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content card">
			<div class="modal-header">
				<h5 class="modal-title">Nâng cấp khách hàng đối tác</h5>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<p for="example-text-input" class="form-control-label">Đặc quyền</p>
							<select class="form-control input-sm chzn-select" name="account_type_vip"id="account_type_vip">
								@foreach($data['type_vip'] as $item)
								    <option  @if((isset($data['account_type_vip']) && $data['account_type_vip'] == $item['code'])) selected @endif value="{{$item['code']}}">{{$item['name']}}</option>
								@endforeach
							</select>
						</div>
					</div>
				...
				<div class="row form-group" id="div_hinhthucgiai">
					<div class="modal-footer">
						<!-- <span id="btn_create"> -->
							<button onclick="JS_Client.upgradeAcc()" class="btn btn-primary btn-sm" type="button">
								Cập nhật
							</button>
						<!-- </span> -->
