    ...
    <table id="table-data" class="table  table-bordered table-striped table-condensed dataTable no-footer">
        ...
        <thead>
            ...
            <td align="center"><input type="checkbox" name="chk_all_item_id"
                ...
                <td align="center"><b><span onclick="JS_CategoryCate.addrow()" class="text-cursor text-primary"><i class="fas fa-plus-square"></i></span></b></td>
            </tr>
        </thead>
        <tbody id="body_data">
            @if(count($datas) > 0)
                ...
                <tr>
                    ...
                    <td class="td_name_category_{{$id}}" onclick="{select_row(this);}" ondblclick="click2('{{$id}}', 'name_category')">
                        <span id="span_name_category_{{$id}}" class="span_name_category_{{$id}}">{{ $data->name_category }}</span>
                    </td>
                    ...
                    <td align="center"><span class="text-cursor text-warning" onclick="JS_CategoryCate.edit('{{$id}}')"><i class="fas fa-edit"></i></span></td>
                </tr>
                @endforeach
            @endif
        </tbody>
