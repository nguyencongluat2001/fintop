...
<div class="card h-100">
    ...
    <div class="card-body" style="padding: 10px !important;">
        <div id="style-1" class="scrollbar ptcp_web" style="padding-right:10px;max-height:900px !important">
            <ul class="list-group">
        ...
        <div class="paginate ptcp_web">
            @if(count($datas) > 0)
            {{$datas->links('pagination.baocaoTTTH')}}
            @endif
        </div><div id="content-mobile" class="ttth_mobile" style="padding-right:10px;max-height:515px !important;overflow-y:scroll;margin-top: .75rem;">
            @if(isset($datas))
            @foreach ($datas as $key => $data)
            @php
